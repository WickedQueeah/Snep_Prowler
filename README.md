...
- **Storage**: Internal Flash partitioned with LittleFS file system for persistent logging (`/packet_log.txt`)
...
- **Exit / Return**: Press `[q]`, `[Q]`, or `[ESC]` from any active mode or detail screen to stop transmissions and return to the previous view or main menu.
